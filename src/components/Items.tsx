...
export default function Items({ items }: { items: { slug: string; data: { title: string } }[] }) {
	return (
		<div className="snap-mandatoy flex w-full snap-y flex-col items-center justify-center scroll-smooth">
			...
			<Item>
				<div className="group relative w-full">
					...
					<div className="text-md invisible w-full translate-y-8 transform pt-10 transition ease-in-out group-hover:visible group-hover:translate-y-0 group-hover:text-white">
